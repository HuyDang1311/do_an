    ...
    <div>
        <section class="ftco-section-no-padding bg-light">
            <div class="hero-wrap">
                ...
                <div class="d-flex">
                    <div class="author-image text img p-md-5" style="background-image: url(/img/frontend/author.jpg);">
        ...
        <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(/img/frontend/bg_1.jpg);">
            <div class="container">
            ...
            <div class="container">
                ...
                <div class="row no-gutters">
                    <div class="col-sm-12 col-md ftco-animate">
                        <a href="/img/frontend/image_1.jpg" class="insta-img image-popup" style="background-image: url(/img/frontend/image_1.jpg);">
                    ...
                    <div class="col-sm-12 col-md ftco-animate">
                        <a href="/img/frontend/image_2.jpg" class="insta-img image-popup" style="background-image: url(/img/frontend/image_2.jpg);">
                            <div class="icon d-flex justify-content-center">
                                <span class="icon-instagram align-self-center"></span>
                            </div>
                        </a>
                    ...
                    <div class="col-sm-12 col-md ftco-animate">
                        <a href="/img/frontend/image_3.jpg" class="insta-img image-popup" style="background-image: url(/img/frontend/image_3.jpg);">
                            <div class="icon d-flex justify-content-center">
                                <span class="icon-instagram align-self-center"></span>
                            </div>
                        </a>
                    ...
                    <div class="col-sm-12 col-md ftco-animate">
                        <a href="/img/frontend/image_4.jpg" class="insta-img image-popup" style="background-image: url(/img/frontend/image_4.jpg);">
                            <div class="icon d-flex justify-content-center">
                                <span class="icon-instagram align-self-center"></span>
                            </div>
                        </a>
                    ...
                    <div class="col-sm-12 col-md ftco-animate">
                        <a href="/img/frontend/image_5.jpg" class="insta-img image-popup" style="background-image: url(/img/frontend/image_5.jpg);">
                            <div class="icon d-flex justify-content-center">
                                <span class="icon-instagram align-self-center"></span>
                            </div>
                        </a>
